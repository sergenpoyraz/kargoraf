...
public partial class SettingsWindow : Window
{
    ...
    public SettingsWindow(SectionService sectionService, BackupService backupService, PackageService packageService, SettingsService settingsService)
    {
        InitializeComponent();
        DataContext = new SettingsViewModel(sectionService, backupService, packageService, settingsService);
    }
